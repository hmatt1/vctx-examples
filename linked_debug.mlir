module {
  ...
  hw.module.extern @regression_brackets_complex_carrier_math_AddOneWidth(in %clk : !seq.clock, in %rst : i1, in %x : i1, out y : i1)
  ...
  func.func @entry() {
    ...
    arc.sim.instantiate @TestAddOneWidth_Harness as %arg0 {
      ...
      arc.sim.set_input %arg0, "a_poke_val" = %c100_i8 : i8, !arc.sim.instance<@TestAddOneWidth_Harness>
      arc.sim.set_input %arg0, "a_poke_en" = %true : i1, !arc.sim.instance<@TestAddOneWidth_Harness>
